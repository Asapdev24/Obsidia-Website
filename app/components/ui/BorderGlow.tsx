...
function parseHSL(hslStr: string): { h: number; s: number; l: number } {
  ...
  if (!match) return { h: 228, s: 76, l: 57 };
...
function buildBoxShadow(glowColor: string, intensity: number): string {
  ...
  // outset-only shadows — never inset, so glow stays outside the button border
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          WebkitMaskComposite: 'destination-out, source-over, source-over, source-over, source-over, source-over',
