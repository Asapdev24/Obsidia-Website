    ...
    <>
      <div data-nav-theme="light" style={{ backgroundColor: 'var(--bg)', minHeight: '100dvh', position: 'relative' }}>
        <div style={{
          ...
          <div
            ...
            style={{ display: 'grid', gridTemplateColumns: '42% 1fr', minHeight: '100dvh' }}
          >
            ...
            <div
              ...
              style={{
                ...
                paddingRight: '56px',
                paddingBottom: '56px',
                paddingLeft: 'calc(max(0px, (100vw - 1200px) / 2) + 32px)',
                marginLeft: 'calc(-1 * max(0px, (100vw - 1200px) / 2) - 32px)',
                width: 'calc(100% + max(0px, (100vw - 1200px) / 2) + 32px)',
              ...
              <div style={{ position: 'relative', zIndex: 1, display: 'flex', flexDirection: 'column', height: '100%' }}>
                ...
                >
                  <p className="font-body" style={{
                    ...
                    color: 'rgba(13,17,71,0.7)', margin: 0,
                  }}>
            ...
            <div
              ...
              style={{ padding: '148px 0 96px 64px', display: 'flex', alignItems: 'flex-start' }}
            >
      ...
      <style>{`
        ...
        @media (max-width: 600px) {
          ...
          .contact-left { margin-left: 0 !important; width: 100% !important; padding: 48px 0 40px !important; }
